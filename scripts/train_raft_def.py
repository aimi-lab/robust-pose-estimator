...
def main(args, config, force_cpu):
    ...
    val2_loader = DataLoader(data_val, num_workers=4, pin_memory=True, batch_size=config['val']['batch_size'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', help="yaml config file", default='../configuration/train_raft_phantom.yaml')
