...
class NewPoseN(PoseN):
    def __init__(self, config):
        super(NewPoseN, self).__init__(config)
        ...
        self.conf_head1 = nn.Sequential(TinyUNet(in_channels=128 + 128 + 9, output_size=(H, W)), activation())
        self.conf_head2 = nn.Sequential(TinyUNet(in_channels=128 + 128 + 9+9, output_size=(H, W)), activation())


    def forward(self, image1l, image2l, intrinsics, baseline, image1r, image2r, toolmask1=None, toolmask2=None, mask1=None, mask2=None, iters=12, flow_init=None, pose_init=None, ret_confmap=False):
        ...
        if self.use_weights:
            ...
            toolmask2,_ = remap_from_flow_nearest(toolmask2, flow_predictions[-1])
