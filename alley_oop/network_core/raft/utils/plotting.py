...
def plot_3d(img1_batch,img2_batch, depth1_batch, depth2_batch, pose_batch, intrinsics, n=0):
    ...
    img1_pcl = SurfelMap(frame=Frame(img1_batch[None, n] / 255.0, depth1_batch[None, n], intrinsics=intrinsics[n]), kmat=intrinsics[n]).transform_cpy(pose_batch[n]).pcl2open3d(stable=False)
    img2_pcl = SurfelMap(frame=Frame(img2_batch[None, n] / 255.0, depth2_batch[None, n], intrinsics=intrinsics[n]), kmat=intrinsics[n]).pcl2open3d(stable=False)
